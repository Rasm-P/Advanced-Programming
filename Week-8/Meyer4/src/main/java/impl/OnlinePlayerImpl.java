 ...
 * @author Rasmus2
 */
public class OnlinePlayerImpl extends PlayerCtrlAbs {
    ...
    private String ip;
    private final EchoClientHandlerImpl echoClientHandler;

    public OnlinePlayerImpl(EchoClientHandlerImpl echoClientHandler) {
    ...
    public void gameWon() {
        ...
        try {
            ...
            Logger.getLogger(OnlinePlayerImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public EchoClientHandlerImpl getEchoClientHandler() {
