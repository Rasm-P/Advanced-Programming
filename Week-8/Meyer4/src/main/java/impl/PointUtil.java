...
public class PointUtil {
    ...
    protected static int turnPointsYesChoiceOnline(int turnRoll, int show, String name, String playerName, int d1, int d2, EchoClientHandlerImpl eco) {
        if (turnRoll == show) {
    ...
    protected static int turnPointsNoChoiceOnline(int roll, int show, String name, String playerName, EchoClientHandlerImpl eco) {
        if (show == roll) {
